...
class EditCustomer:
    """Edit Customer view logic - works with the EditCustomer page in stackedWidget"""
    ...
    def setup_EditCustomer_ui(self):
        ...
        # Sidebar buttons
        side_buttons = ["Homebut_13", "Userbut_13", "Dashbut_13", "Orderbut_13",
                        "Reportbut_13", "Settbut_13"]
